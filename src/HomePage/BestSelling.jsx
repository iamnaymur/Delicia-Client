    ...
    <>
      <div>
        <p className="text-4xl font-semibold mb-20">
          Our most selling foods this month -
        </p>
      </div>
      <div className="md:flex items-center  bg-green-100 p-5">
        <div>
      ...
      <hr />
      <div className="md:flex items-center  bg-yellow-100 p-5">
        <div>
          <img
            style={{ width: "900px", height: "200px" }}
      ...
      <hr />
      <div className="md:flex items-center  bg-orange-100 p-5">
        <div>
